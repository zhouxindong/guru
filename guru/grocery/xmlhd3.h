//#pragma once
//#ifndef _GURU_XMLHD3_H_
//#define _GURU_XMLHD3_H_
//
//#ifdef _MSC_VER
...
//
///*
//converts utf input to wide char and vice versa
//*/
//class XMLU
//{
//public:
...
//
///*
//same as string with unicode part
//*/
...
//
///*
//base class for XMLComment, XMLCData, XMLDocType, XMLVariable/XMLAttribute
//1. Constructor can initialize from:
//XMLContent v("n");
//XMLContent v2 = v;
//
//2. Enhancements
...
//	std::wstring GetWideValue(int CP = CP_UTF8) const;
//	std::string GetValueDefault(const char* def) const;
//	size_t GetEP() const;
//
//	// Serialization
...
//
///*
//XMLVariable includes methods to set/get the attribute name. 
//With the same functions, all these classes can now, 
//for example, set binary values for their contents.
//*/
...
//
///*
//The XML header class contains the standalone, version and encoding as attributes, 
//so you can access them via XMLVariable.
//*/
//class XMLHeader
//{
//private:
...
//
///*
//1. shared_ptr arrays of all child elements, contents, comments, cdatas, attributes.
//vector<shared_ptr<XMLElement>> v = el.GetChildren();
//
//2. Access to elements via operator [] and an index:
//el[0].vv["animal"] = "rabbit";
//
//3. Access via operator [] and a string, creates children if they do not exist:
//el["hello"]["there"] = "<there v=\"test\">";
//
//4. Access to attributes via v() with index or variable name, or with vv() for the full XMLVariable:
//string g = el.v("t");
//
//5. Copy or mirror:
...
//
//6. Access to parent using XMLId:
//*/
//class XMLElement
//{
//private:
...
//	std::shared_ptr<XMLElement> GetParent(std::shared_ptr<XMLElement> r) const;
...
//	// Crypto
//#ifdef _WIN32
//	HRESULT XMLElement::Verify();
//	HRESULT XMLElement::Sign(std::vector<PCCERT_CONTEXT> cert, const wchar_t* algo = L"SHA256", const LPCWSTR sl = L"/Signature");
//	std::string XMLElement::Encrypt(const char* d, ULONG l);
//#endif
//};
//
///*
//1. Construct empty, from ansi/unicode file, from memory.
//2. Save to memory, file or FILE*.
//3. operator = to parse text.
//4. Contains an XMLHeader, an XMLDocType, a vector of XMLComment and the root XMLElement.
//*/
//class XML
//{
//private:
...
//	}
//
//	inline std::shared_ptr<XMLElement> XMLElement::GetParent(std::shared_ptr<XMLElement> r) const
//	{
...
//				{
//					v2 = variables;
//					std::sort(v2.begin(), v2.end(), [](std::shared_ptr<XMLVariable> e1, std::shared_ptr<XMLVariable> e2) -> bool
//					{
...
//	}
//
//	inline bool XML::ready() const noexcept
//	{
//		return _loaded == XML_PARSE::OK;
//	}
//
//_GURU_END
//
//#endif /* _GURU_XMLHD3_H_ */